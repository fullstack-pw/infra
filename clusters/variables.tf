  ...
  default = {
    ...
    k3s-test = {
      ...
      postgres_cnpg = {
        ...
        use_istio                      = true
        export_credentials_secret_name = "test-postgres-credentials"
        vault_ca_secret_path           = "cluster-secret-store/secrets/TEST_POSTGRES_CA"
        vault_ca_secret_key            = "TEST_POSTGRES_CA"
      }
    }
    dev = {
